        ...
        <div class="modal fade" id="editAnggotaModal{{ $anggota->organisasi_card_id }}" tabindex="-1" aria-labelledby="editAnggotaModalLabel{{ $anggota->organisasi_card_id }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.update_anggota', $anggota->organisasi_card_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row gy-3">
                                <div class="col-12 text-center">
                                    ...
                                    <div class="bg-blue-dark rounded-3 text-center overflow-hidden mx-auto" style="width:213px; height:213px;">
                                        <img src="{{ asset('image/' . $anggota->foto) }}" id="previewAnggota{{ $anggota->organisasi_card_id }}" alt="" style="object-fit: cover; width:100%; height:100%;">
                                    </div>
    ...
    <div class="modal fade" id="addAnggotaModal" tabindex="-1" aria-labelledby="addAnggotaModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.create_anggota') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-outline-success">Tambah Pengurus</button>
                    </div>
                </form>
            </div>
        </div>
