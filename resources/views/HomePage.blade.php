...
<div class="container-fluid mt-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-3 text-center mb-4">
            <img src="{{asset('image/icon/' . $kontens[1]->icon )}}" class="img-fluid mb-3" alt="{{ 'icon' . $kontens[1]->judul }}">
            <h2 class="my-4 card-header-2">{{ $kontens[1]->judul }}</h2>
            <p class="card-text">{{ $kontens[1]->deskripsi }}</p>
        </div>
        <div class="col-12 col-md-3 text-center mb-4">
            <img src="{{asset('image/icon/' . $kontens[2]->icon )}}" class="img-fluid mb-3" alt="{{ 'icon' . $kontens[2]->judul }}">
            <h2 class="my-4 px-5">{{ $kontens[2]->judul }}</h2>
            <p class="card-text">{{ $kontens[2]->deskripsi }}</p>
        </div>
        <div class="col-12 col-md-3 text-center mb-4">
            <img src="{{asset('image/icon/' . $kontens[3]->icon )}}" class="img-fluid mb-3" alt="{{ 'icon' . $kontens[3]->judul }}">
